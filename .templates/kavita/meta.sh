...
SERVICE_DESC="Manga, comics, and book server"
SERVICE_ICON="📚"
SERVICE_ARCH="all"
SERVICE_TAGS="media books comics manga"
SERVICE_DEPS=""       # e.g. "postgres redis"  — leave empty if none
SERVICE_CONFIGS=""    # e.g. "Caddyfile"  or  "glances.conf app.ini"